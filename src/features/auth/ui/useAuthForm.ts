...
import { setCredentials, useLoginUserMutation, useRegisterUserMutation } from '@entities/user';
...
export const useAuthForm = () => {
    ...
    const [
        { mode, email, password, confirmPassword, errors, requestError, successMessage },
        dispatch,
