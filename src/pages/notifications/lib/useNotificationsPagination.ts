...
const getMobileNavigationHeight = () =>
    Number.parseFloat(
    ...
    useLayoutEffect(() => {
        ...
        const updateItemsPerPage = () => {
            ...
            const paginationHeight =
                paginationRef.current?.getBoundingClientRect().height || FOOTER_HEIGHT;
            ...
            const nextItemsPerPage = Math.max(
                1,
                Math.floor((availableHeight + LIST_GAP) / (itemHeight + LIST_GAP)),
            );
