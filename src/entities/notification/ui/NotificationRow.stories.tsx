...
const base = { id: 'chain-1:incoming_offer', kind: 'incoming_offer' as const, chain_id: 'chain-1', title: 'Вам предложили обмен', body: 'Пользователь предлагает обменять свой товар.', status: 'pending' as const, updated_at: '2026-08-09T12:00:00Z', href: '/exchanges/chain-1', read_at: null };
const meta = { title: 'Entities/NotificationRow', component: NotificationRow, args: { notification: base, onOpen: async () => undefined } } satisfies Meta<typeof NotificationRow>;
export default meta;
